...
export function AuditDecisionsPage() {
  return (
    <ResearchPageShell
      ...
      panelTitle="Governance register"
      panelDescription="Review decision IDs, change rationale, owner approval, evidence references, affected phase      panelTitle="Decision and audit register"
